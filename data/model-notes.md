...
## Electricity and public-support constraints

The IEA Energy and AI report estimates data center electricity consumption at around 415 TWh in 2024 and projects around 945 TWh by 2030 in the base case. The game uses that steep 2024-2030 shape for annual pressure and makes power, cooling, water, and community legitimacy separate resources.

IEA also reports that renewables meet nearly half of additional data center electricity demand to 2030, while natural gas and coal remain important near-term sources. In game terms, fast gas capacity can solve reliability quickly but hurts support and emissions; renewables and grid interconnects improve legitimacy but need planning.
...
Each region uses state-level real-world inputs:

- 2024 state population from Census ACS table B01003.
- 2025 current-dollar state GDP from BEA SAGDP1 line 3.
- 2024 industrial electricity price from EIA Electric Power Annual table 2.10.
- 2024 presidential margin from official FEC results compiled from state election offices.

The location modifiers are intentionally transparent:

- Higher population and permitting difficulty increase public-support sensitivity.
- Lower industrial electricity prices reduce power-project cost.
- Larger labor markets slightly improve compute deployment efficiency.
- Higher water-stress scores reduce water project effectiveness and increase water demand pressure.
- State political context changes policy support: business-friendly/low-permit-friction states are easier to build in, while swing or high-scrutiny states punish visible mistakes faster.

## Mechanics compression

- One budget credit is an abstract public/private financing unit.
- H100e values are shown in millions in the UI.
- Power is modeled as MW of available supply versus MW of frontier demand pressure.
- Cooling target is 30% of power target, based on IEA's discussion that cooling can vary from about 7% to over 30% depending on data center type.
- Water target is an abstract ML/day requirement based on the power target and cooling intensity.
- Political and people support are independent fail states. You can have enough compute and still lose if siting, emissions, and water stress destroy permission to build.
